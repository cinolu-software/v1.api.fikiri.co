...
export class AddEventImages1716195442400 implements MigrationInterface {
  name = 'AddEventImages1716195442400';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE \`event_images_image\` (\`eventId\` int NOT NULL, \`imageId\` int NOT NULL, INDEX \`IDX_4bf8c74b5f4a1113b2bca95201\` (\`eventId\`), INDEX \`IDX_fb0313bb02cfd78a2eb66ca6dc\` (\`imageId\`), PRIMARY KEY (\`eventId\`, \`imageId\`)) ENGINE=InnoDB`
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`ALTER TABLE \`event_images_image\` DROP FOREIGN KEY \`FK_fb0313bb02cfd78a2eb66ca6dcd\``);
    await queryRunner.query(`ALTER TABLE \`event_images_image\` DROP FOREIGN KEY \`FK_4bf8c74b5f4a1113b2bca952019\``);
    await queryRunner.query(`ALTER TABLE \`user\` DROP FOREIGN KEY \`FK_642763a1acbc9672d38429ea62a\``);
    await queryRunner.query(`ALTER TABLE \`user\` DROP FOREIGN KEY \`FK_659711c5971695cda97f7db52a2\``);
    await queryRunner.query(`ALTER TABLE \`solution\` DROP FOREIGN KEY \`FK_ed090fd84e131ffea722335fe99\``);
    await queryRunner.query(`ALTER TABLE \`solution\` DROP FOREIGN KEY \`FK_577971bf35a3f85b2d6edd8329e\``);
    ...
    await queryRunner.query(`DROP INDEX \`IDX_fb0313bb02cfd78a2eb66ca6dc\` ON \`event_images_image\``);
    await queryRunner.query(`DROP INDEX \`IDX_4bf8c74b5f4a1113b2bca95201\` ON \`event_images_image\``);
